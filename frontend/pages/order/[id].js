  ...
  return (
    <Layout>
      {loadingScreenOrder || Object.keys(order).length === 0 ? (
        ...
        <Message color="red" variant="danger">
          {error}
        </Message>
      ) : (
        <>
          ...
          <div className="lg:grid lg:grid-cols-12 gap-4 custom-container text-gray-700">
            <div className="col-span-8">
              ...
              <div className="border-gray-300 border-b pb-8">
                ...
                {order.isDelivered ? (
                  <Message color="blue" variant="700">
                    Delivered on {order.deliveredAt}
                  </Message>
                ) : (
                  <Message color="red" variant="400">
                    Not Delivered
                  </Message>
                )}
              </div>
            ...
            <div className="col-start-9 col-span-4">
              <div className="border-gray-300 border pb-4 mt-4">
                ...
                <div className="flex justify-between pb-4 border-gray-300 border-b">
                  ...
                  <div>
                    <p className="pt-4 px-6">${order.shippingPrice}</p>
                  </div>
                </div>
                <div className="flex justify-between pb-4 border-gray-300 border-b">
                  <div>
                  ...
                  <div>
                    <p className="pt-4 px-6">${order.taxPrice}</p>
                  </div>
                </div>
                <div className="flex justify-between">
                  ...
                  <div>
                    <p className="pt-4 px-6">${order.totalPrice}</p>
                  </div>
                </div>
                {!order.isPaid && (
