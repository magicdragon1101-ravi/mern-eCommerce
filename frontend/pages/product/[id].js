        ...
        <div className="custom-container">
          ...
          <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="text-gray-800">
              <h3 className="text-4xl uppercase text-gray-700 leading-10 pb-5 border-b border-gray-300">
                {product.name}
              </h3>
              ...
              <div className="border-gray-400 border">
                ...
                {product.countInStock > 0 && (
                  <div className="border-gray-400 border-t border-b flex justify-between">
                    ...
                    <select
                      className="inline-block mr-5 px-5 py-3"
                      value={qty}
                  ...
                  <div className="px-5 my-3 flex justify-center">
                    <button
                      className={`px-16 py-2 text-white ${
                        product.countInStock === 0 ? "bg-gray-500 cursor-not-allowed" : "bg-black"
                      }`}
