...
const UsersAdminPage = () => {
  ...
  const {
    userInfo,
    getListUsers,
    userListScreen: { userList, loading: loadingUserList, success: successUserList, error: errorUserList },
  } = UserContext;
          ...
          <table className="table p-4 bg-white shadow rounded-lg">
            <thead>
              <tr>
                ...
                <th className="border-b-2 p-4 dark:border-dark-5 whitespace-nowrap font-normal text-gray-900">NAME</th>
                <th className="border-b-2 p-4 dark:border-dark-5 whitespace-nowrap font-normal text-gray-900">EMAIL</th>
                <th className="border-b-2 p-4 dark:border-dark-5 whitespace-nowrap font-normal text-gray-900">ADMIN</th>
            ...
            <tbody>
              {userList.map((user, index) => (
                <tr className="text-gray-700" key={index}>
                  ...
                  <td className="border-b-2 p-4 dark:border-dark-5">{user._id}</td>
                  ...
                  <td className="border-b-2 p-4 dark:border-dark-5">
                    <div className="flex items-center">
                      <Link href={`/admin/user/${user._id}/edit`}>
                        <button
                          type="button"
                          className="w-full border-l border-t border-b text-base font-medium rounded-l-md text-black bg-white hover:bg-gray-100 px-4 py-2 border-r border-gray-300"
                        >
