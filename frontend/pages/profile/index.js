        ...
        <div className="col-span-2">
          ...
          <form onSubmit={submitHandler}>
            <div className="my-6 flex flex-col">
              ...
              <input
                className="block py-4 px-6 bg-gray-300"
                type="name"
                      ...
                      <tr key={index}>
                        ...
                        <td className="text-left py-3 px-2">
                          {order.isPaid ? (
                            ...
                            <FontAwesomeIcon
                              icon={faTimes}
                              style={{ color: "#c53030", marginTop: "12px", marginLeft: "25px" }}
                            />
                          )}
                        </td>
                        <td className="text-left py-3 px-2">
                        ...
                        <td className="text-left py-3 px-2">
                          <Link href={{ pathname: "/order/[id]", query: { id: order._id } }} as={`/order/${order._id}`}>
