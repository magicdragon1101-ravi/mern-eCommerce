...
const ProductCard = ({ product }) => {
  return (
    <Link href={{ pathname: "/product/[id]", query: { id: product._id } }} as={`/product/${product._id}`}>
      <div className="border border-gray-400 px-4 md:px-6 pt-6 pb-10 rounded-lg cursor-pointer">
        ...
        <div className="mx-auto px-4 md:px-6 tracking-wider pt-4">
          ...
          <Rating value={product.rating} text={`${product.numReviews} reviews`} color={"#ecc94b"} classNames={"pt-3"} />
